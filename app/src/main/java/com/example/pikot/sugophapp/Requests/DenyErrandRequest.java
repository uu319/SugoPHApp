...
public class DenyErrandRequest {

    private static ProgressDialog progressDialog;

    public static void denyErrand(final Context context, final String errand_id, final CallBacks callBacks) {
        String URL = Constants.URL_DENY_ERRAND;
