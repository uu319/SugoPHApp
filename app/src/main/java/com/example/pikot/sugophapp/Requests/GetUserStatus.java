...
public class GetUserStatus {
    ...
    public static void getStatus(final Context context, final String username, final CallBacks callBacks) {
        progressDialog= new ProgressDialog(context);
        progressDialog.setMessage("Please1 wait...");

        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_GET_STATUS,
