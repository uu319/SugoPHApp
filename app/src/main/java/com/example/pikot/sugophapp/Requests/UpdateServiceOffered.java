...
public class UpdateServiceOffered {
    private static ProgressDialog progressDialog;
    public static void updateServiceOffered(final Context context, final String option_id, final String status, final CallBacks callBacks) {
        progressDialog = new ProgressDialog(context);
        progressDialog.setMessage("Updating");
        progressDialog.show();
        String URL = Constants.URL_UPDATE_SERVICE_OFFERED;
