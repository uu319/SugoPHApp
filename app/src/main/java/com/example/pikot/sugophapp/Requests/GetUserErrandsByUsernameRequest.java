...
public class GetUserErrandsByUsernameRequest {

    private static ProgressDialog progressDialog;
    public static void getUserErrandsByUsername(final Context context,final CallBacks callBacks) {
//        progressDialog= new ProgressDialog(context);
//        progressDialog.setMessage("Please1 wait...");
//        progressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_GET_ESEEKER_ERRANDS_BY_USERNAME,
