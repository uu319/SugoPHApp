...
public class AcceptErrandRequest {

    private static ProgressDialog progressDialog;
    public static void acceptErrand(final Context context, final String errand_id, final CallBacks callBacks) {
        progressDialog = new ProgressDialog(context);
        progressDialog.setMessage("Please wait");
//        progressDialog.setCancelable(false);
        progressDialog.show();
        String URL = Constants.URL_ACCEPT_ERRAND;
