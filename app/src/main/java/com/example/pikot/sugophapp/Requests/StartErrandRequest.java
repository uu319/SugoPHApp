...
public class StartErrandRequest {

    private static ProgressDialog progressDialog;

    public static void startErrand(final Context context, final String errand_id, final CallBacks callBacks) {
        progressDialog = new ProgressDialog(context);
        progressDialog.setMessage("Starting errand, please wait");
//        progressDialog.setCancelable(false);
        progressDialog.show();
        String URL = Constants.URL_START_ERRAND;
