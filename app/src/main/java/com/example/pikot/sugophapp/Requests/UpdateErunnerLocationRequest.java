...
public class UpdateErunnerLocationRequest {

    private static ProgressDialog progressDialog;

    public static void updateLocation(final Context context, final String location,
                                      final CallBacks callBacks) {
        String URL = Constants.URL_UPDATE_ERUNNER_LOCAATION;
