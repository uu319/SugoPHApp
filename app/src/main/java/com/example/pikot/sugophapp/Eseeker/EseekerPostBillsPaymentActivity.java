...
public class EseekerPostBillsPaymentActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eseeker_post_bills_payment);
        if(!SharedPrefManager.getInstance(this).isLoggedIn()) {
            ...
            if(catId.equals("5")){
                description="Please get me this document";
            }else{
                description="Please run this bills payment for me";
            }
        ...
        GetErrandOptionsRequest.getErrandOptions(this, errcat, new CallBacks() {
            ...
            public void onSuccess(String response) throws JSONException {
                if (response != null) {
                    ...
                    ShowAlert.showAlert(EseekerPostBillsPaymentActivity.this, "Something went wrong with your connection.");
//                    Toast.makeText(EseekerPostBillsPaymentActivity.this, "Something Went Wrong", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        GetOptionDescriptionRequest.getOptionDescription(this, new CallBacks() {
            ...
            public void onSuccess(String response) throws JSONException {
                if (response != null) {
                    ...
                    if(error){
                        try{
                            ShowAlert.showAlert(EseekerPostBillsPaymentActivity.this,jsonObject.getString("msg"));
                        }catch (Exception e){
                            e.printStackTrace();
                        }
...
//                        Toast.makeText(getApplicationContext(),jsonObject.getString("msg"),Toast.LENGTH_LONG).show();
                    ...
                    ShowAlert.showAlert(EseekerPostBillsPaymentActivity.this,"Something went wrong with your conneccton.");
